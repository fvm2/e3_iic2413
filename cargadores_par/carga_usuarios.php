<?php
    ...
    // Get csv file
    if (($handle = fopen("data/pares/filtered_data/usuarios.csv", "r")) !== FALSE) {
        $n = 1;
        $stmt = $db->prepare('INSERT INTO usuarios (id_usuario,nombre,username,mail,password,fecha_nacimiento) VALUES (?, ?, ?, ?, ?, ?)'); 
