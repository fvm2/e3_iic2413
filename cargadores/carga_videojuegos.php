<?php
    ...
    // Get csv file
    if (($handle = fopen("data/pares/filtered_data/videojuegos.csv", "r")) !== FALSE) {
        $n = 1;
        $stmt = $db->prepare('INSERT INTO Videojuegos (id_videojuego,titulo,puntuacion,clasificacion,fecha,beneficio_preorden) VALUES (?, ?, ?, ?, ?, ?)'); 
